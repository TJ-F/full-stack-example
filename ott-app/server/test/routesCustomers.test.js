...
describe('Customer Routes', function () {
    ...
    beforeEach(() => {
        ...
        adminToken = generateTestToken(true);  // admin token
    ...
    it('POST /customer/promote_to_admin should promote customer to admin', async () => {
        // Set admin flag before generating adminToken so the token is for an admin user
        adminToken = generateTestToken(true);
        currentAdminFlag = true; // Simulate admin user
        const res = await request
